...
class Session(object):
    ...
    def __init__(self):
        ...
        self.username = 'jd' if global_config.get('account', 'username') is None else global_config.get('account', 'username')
        self.isLogin = False
        self.password = global_config.get('account', 'payment_pwd')

        #使用session实现跨网页的数据记录，cookie的共享
